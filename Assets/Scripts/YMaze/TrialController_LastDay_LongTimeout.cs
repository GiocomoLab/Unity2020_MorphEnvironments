...
public class TrialController_LastDay_LongTimeout: MonoBehaviour
{
    ...
    IEnumerator InterBlockInterval()
    {
        ...
        // Even trials, set tunable wavelength to 920 
        if ((blockNumber % 2) == 0)
        {
            sendString("V0");
            Debug.Log("Setting wavelength to 920");
        }
        // Odd trials, set tunable wavelength to 1040 
        else
        {
            sendString("V1");
            Debug.Log("Setting wavelength to 1040");
