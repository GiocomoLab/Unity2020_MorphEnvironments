...
public class PC_new_novelobject : MonoBehaviour
{
    ...
    private SP_new_novelobject sp;
    private DL_new_novelobject dl;
    private RR_new_novelobject rotary;
    private SbxTTLs_new_novelobject sbxttls;
    ...
    public void Start()
    {
        ...
        sp = player.GetComponent<SP_new_novelobject>();
        rotary = player.GetComponent<RR_new_novelobject>();
        dl = player.GetComponent<DL_new_novelobject>();
        sbxttls = player.GetComponent<SbxTTLs_new_novelobject>();
