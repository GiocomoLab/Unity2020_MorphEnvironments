...
public class PC_runtrain_novelobject : MonoBehaviour
{
    ...
    private SP_runtrain_novelobject sp;
    private DL_runtrain_novelobject dl;
    private RR_runtrain_novelobject rotary;
    private SbxTTLs_runtrain_novelobject sbxttls;
    ...
    public void Start()
    {
        ...
        sp = player.GetComponent<SP_runtrain_novelobject>();
        rotary = player.GetComponent<RR_runtrain_novelobject>();
        dl = player.GetComponent<DL_runtrain_novelobject>();
        sbxttls = player.GetComponent<SbxTTLs_runtrain_novelobject>();
