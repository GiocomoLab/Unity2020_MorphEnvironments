...
public class SP_runtrain_novelobject : MonoBehaviour
{
    ...
    private RR_runtrain_novelobject rr;
    private DL_runtrain_novelobject dl;
    private PC_runtrain_novelobject pc;
    private SbxTTLs_runtrain_novelobject ttls;
    private Notes notes;
    ...
    public void Awake()
    {
        ...
        rr = player.GetComponent<RR_runtrain_novelobject>();
        dl = player.GetComponent<DL_runtrain_novelobject>();
        pc = player.GetComponent<PC_runtrain_novelobject>();
        ttls = player.GetComponent<SbxTTLs_runtrain_novelobject>();
