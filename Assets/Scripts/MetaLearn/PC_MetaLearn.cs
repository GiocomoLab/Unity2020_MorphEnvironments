...
public class PC_MetaLearn : MonoBehaviour
{
    ...
    private DL_MetaLearn dl;
    private RR_MetaLearn rotary;
    private SbxTTLs_MetaLearn sbxttls;
    ...
    public void Start()
    {
        ...
        sbxttls = player.GetComponent<SbxTTLs_MetaLearn>();
        rotary = player.GetComponent<RR_MetaLearn>();
        dl = player.GetComponent<DL_MetaLearn>();
        Debug.Log(sp.sceneName);
        if ((sp.sceneName == "MetaLearn_LocationA") )
        {
           
            reward = GameObject.Find("Reward");
        }
        else if ((sp.sceneName == "MetaLearn_LocationB")) 
        {
            reward = GameObject.Find("Reward");
