...
public class TrialOrdering_TwoReward : MonoBehaviour {
    ...
    void Start()
    {
        ...
        {
            trainingTrials[2 * i] = 1f;
            trainingTrials[2 * i + 1] = 0f;
        }
